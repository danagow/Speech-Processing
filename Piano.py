...
txtDisplay=Entry(topframe,textvariable= value, insertwidth=5, font =40 , justify= 'center', width= 4,state='readonly')
txtDisplay.grid(row=1, column=1, pady = 5,ipady = 5)
txtDisplay2=Entry(topframe,textvariable= sNote, insertwidth=10, font =0 , justify= 'center', width= 4,state='readonly')
txtDisplay2.grid(row=0, column=1, pady = 5,ipady =9)
singing.set('Sing')
